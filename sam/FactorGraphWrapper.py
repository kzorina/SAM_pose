    ...
    def swap_chunks(self, tracks):
        ...
        for obj_label in tracks:
            for track in tracks[obj_label]:
                ...
                # new_graph.add(gtsam.PriorFactorPose3(track.get_symbol(), T_wo, huber_noise))
                ...
                for derivative_symbol in track.get_active_derivative_symbols():
                    ...
                    # huber_noise = gtsam.noiseModel.Robust.Create(gtsam.noiseModel.mEstimator.Huber.Create(1.5), derivative_noise)
                    # new_graph.add(gtsam.PriorFactorVector(derivative_symbol, derivative, huber_noise))
